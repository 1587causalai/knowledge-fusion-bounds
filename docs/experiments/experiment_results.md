...
<img src="docs/assets/position_only_same_direction.png" alt="同向位置参数扰动下的KL散度比较">
...
<img src="docs/assets/position_only_opposite_direction.png" alt="反向位置参数扰动下的KL散度比较">
...
<img src="docs/assets/position_only_ratio_boxplot.png" alt="位置参数扰动下的KL散度比率">
...
<img src="docs/assets/multivariate_inequality_holds.png" alt="多维情况下不等式成立的比例">
...
<img src="docs/assets/multivariate_ratio_boxplot.png" alt="多维情况下的KL散度比率">

### 5.3 KL散度散点图

下图展示了融合分布KL散度与不等式右侧值的散点图：

<img src="docs/assets/multivariate_scatter.png" alt="KL散度比较散点图">
...
<img src="docs/assets/optimal_constant_max_ratio.png" alt="不同维度d和扰动数量N下的最大比率">
...
<img src="docs/assets/optimal_constant_mean_ratio.png" alt="不同维度d和扰动数量N下的平均比率">
